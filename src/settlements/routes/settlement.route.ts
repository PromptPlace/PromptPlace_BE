 ...
 *                 summary:
 *                   type: object
 *                   description: 월 전체 합계 (페이지 무관)
 *                   properties:
 *                     count: { type: integer, description: 월 전체 거래 건수, example: 25 }
 *                     total_sales: { type: integer, description: 원래 판매가 합계 (환불 포함), example: 250000 }
 *                     total_settled: { type: integer, description: net 정산 금액 (환불 제외), example: 200000 }
